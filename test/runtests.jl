...
@testset "Phonetics tests" begin

    @testset "Caverphone" begin
        @test caverphone("Lee") ==  "l11111"
        @test caverphone("Thompson") ==  "tmpsn1"
    end

    @testset "Soundex" begin
    ...
    @testset "#NB: reference seemed confused about these two examples." begin
        @test metaphone("Van Hoesen") ==  "fnhs"
        @test metaphone("Vincenzo") ==  "fnsn"
    end

    @testset "Phonex" begin
    ...
    @testset "Double-Metaphone" begin
